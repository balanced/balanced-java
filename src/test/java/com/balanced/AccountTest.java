...
public class AccountTest extends BaseTest {
	...
	@Test
	public void testAssociatedFunding() throws CannotCreate, HTTPError, NoResultsFound, MultipleResultsFound {
	...
	@Test
	public void testCredit() throws CannotCreate, HTTPError, NoResultsFound, MultipleResultsFound {
		Marketplace mp = Marketplace.mine();
		fundEscrow(mp);
	...
	@Test
	public void testDebit() throws CannotCreate, HTTPError, NoResultsFound, MultipleResultsFound {
		Marketplace mp = Marketplace.mine();
	...
	@Test
	public void testHold() throws CannotCreate, HTTPError, NoResultsFound, MultipleResultsFound {
		Marketplace mp = Marketplace.mine();
		Account account = createBuyer(mp);
